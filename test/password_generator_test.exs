defmodule PasswordGeneratorTest do
  ...
  setup do
    ...
    {:okay, result} = PasswordGenerator.generate(options)
  ...
  test "returns error when no length is given" do
    ...
    {:error, _error} = PasswordGenerator.generate(options)
  end
  ...
  test "length of returned string is the option provided" do
    ...
    {:okay, result} = PasswordGenerator.generate(length_option)
  ...
  test "returns string uppercase", %{options_types: options} do
    ...
    {:okay, result} = PasswordGenerator.generate(uppercaseOptions)
